...
export const setIdentity = (identity) => {
  return { type: Actions.SET_IDENTITY, identity };
};

export const setRoomId = (roomId) => {
  return { type: Actions.SET_ROOM_ID, roomId };
};

export const setShowOverlay = (showOverlay) => {
  return { type: Actions.SET_SHOW_OVERLAY, showOverlay };
};

export const setParticipants = (participants) => {
  return { type: Actions.SET_PARTICIPANTS, participants };
};
...
export const setDirectChatHistory = (history) => {
  return { type: Actions.SET_DIRECT_CHAT_HISTORY, history };
};

export const setSocketId = (socketId) => {
  return { type: Actions.SET_SOCKET_ID, socketId };
};
